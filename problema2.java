...
public class problema2 {
    public static void main(String[] args) throws IOException {
        ...
        n100 = N / 100.0;
        N %= 100; //resto da divisão por 100
        n50 = N / 50.0;
        N %= 50; //resto da divisão por 50
        n20 = N / 20.0;
        N %= 20; //resto da divisão por 20
        n10 = N / 10.0;
        N %= 10; //resto da divisão por 10
        n5 = N / 5.0;
        N %= 5; //resto da divisão por 5
        n2 = N / 2.0;
        N %= 2; //resto da divisão por 2
        n1 = N / 1.0;
        N %= 1; //resto da divisão por 1
